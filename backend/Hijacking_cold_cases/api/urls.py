...
from .views import (
    ...
    GenerateCaseBatchView, GeneratePersonView, ActiveCaseView, PersonListView, GuessKillerView, CaseInstanceStatusView, ForfeitCaseView,
)
...
urlpatterns = [
    ...
    path("cases/<int:pk>/instance/", CaseInstanceStatusView.as_view()),
    ...
    path("cases/<int:pk>/forfeit/", ForfeitCaseView.as_view(), name="forfeit-case"),
